      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6 rounded">
          ...
          <ol className="list-decimal list-inside text-blue-800 text-sm space-y-1">
            ...
            <li>Connect to the WiFi network: "Busina-Setup-XXXX"</li>
            <li>Open http://192.168.4.1 in your browser</li>
            <li>Fill in your WiFi details and device name there</li>
            <li>Device will restart and appear here in 30 seconds</li>
          </ol>
        </div>
        ...
        {loading ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">Looking for devices...</p>
          </div>
        ) : devices.length === 0 ? (
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 text-center">
            <AlertCircle className="mx-auto mb-3 text-yellow-600" />
            <p className="text-yellow-800">
              No devices found. Press the pairing button on your hardware to get
              started.
            </p>
          </div>
        ) : (
          <div className="bg-white rounded-lg shadow-lg overflow-hidden mb-6">
            <div className="px-6 py-4 bg-gray-50 border-b">
              <h2 className="font-bold text-gray-800">Available Devices</h2>
            </div>
